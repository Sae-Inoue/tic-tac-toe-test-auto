...
def is_win(player):
    ...
    :parameter
    player : string
    To check which player is win("X" or "O")

    :return : boolean
    If it is True, the player has won.
...
def tally_wins(results):
    ...
    '''
    Tallies the number of wins from the results list

    :param
    results: list
    This list stores True for win, false for loss.

    :return: int
    This is the total number of win.
    '''
    return sum(results)
